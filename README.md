...
![image](https://github.com/user-attachments/assets/a5c32eb9-5139-433a-a929-e9c11899a96d)
4. Open command prompt within the directory.
5. Execute malicious_filter.py with the following command.
```
